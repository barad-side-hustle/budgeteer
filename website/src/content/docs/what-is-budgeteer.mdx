...
**Beta.** Built by [Alon Barad](https://github.com/alon710) for personal use first and then released. MIT licensed. Issues and PRs welcome on [GitHub](https://github.com/barad-side-hustle/budgeteer).
