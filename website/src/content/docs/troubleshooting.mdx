...
Either way, `http://127.0.0.1:2412` always works.
...
### "Cannot connect to localhost:2412"
...
Clear your browser cache for `localhost:2412`. The dashboard's assets are cached aggressively.
...
```sh
sqlite3 data/budgeteer.db ".backup data/budgeteer-backup.db"
```
